...
dircorvals = "/data/clusterfs/lag/users/gokala/dyslexia-evol/corvals/"
##Output file
foutput = "/data/clusterfs/lag/users/gokala/dyslexia-evol/corvalues_BJK.pdf"

##Make a pdf file of correlation estimates
pdf(foutput);
par(las=1);
    ##Read in correlation values
    corvals = read.csv("/data/clusterfs/lag/users/gokala/dyslexia-evol/corvals/corvalues_Dyslexia_BJK.csv")
