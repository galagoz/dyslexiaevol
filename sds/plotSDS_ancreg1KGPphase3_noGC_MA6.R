...
corvals = read.csv("/data/clusterfs/lag/users/gokala/dyslexia-evol/sds/SDS_bjk_ancreg_dyslexia.csv")

# Make a table with SDS results

colnames(corvals)=c("Data","Global Correlation Spearman","Estimated Mean", "Estimated Standard Error", "Estimated Z-score", "Estimated p-value")
corvals[1,1]="23andMe"
save_kable(kable(corvals, "latex", booktabs = T),"/data/workspaces/lag/workspaces/lg-genlang/Working/23andMe/Dyslexia2/Evolution/plots/sds/sds_results.pdf")
