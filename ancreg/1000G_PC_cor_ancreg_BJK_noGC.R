...
frdatafile="/data/clusterfs/lag/users/gokala/dyslexia-evol/ancreg_sumstat/Dyslexia_ancreg.Rdata"
phenoname="Dyslexia"
outputdir="/data/clusterfs/lag/users/gokala/dyslexia-evol/corvals/"
