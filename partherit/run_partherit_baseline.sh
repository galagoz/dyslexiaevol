...
/data/clusterfs/lag/users/gokala/dyslexia-evol/partherit/partherit_baseline.sh '$a' '$annot' '$tmp_output'' > $shellFile
...
/data/clusterfs/lag/users/gokala/dyslexia-evol/partherit/partherit_baseline_and_extraAnnot.sh '$a' '$annot' '$tmp_output' '$baseline'' > $shellFile
